    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo $this->url('partners/create'); ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="<?php echo $this->escape($data['nom'] ?? ''); ?>"
                                   required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url"
                                   ...
                                   value="<?php echo $this->escape($data['logo'] ?? ''); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url"
                                   ...
                                   value="<?php echo $this->escape($data['siteweb'] ?? ''); ?>"
                                   required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="<?php echo $this->escape($data['contact'] ?? ''); ?>">
